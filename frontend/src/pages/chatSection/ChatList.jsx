  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="p-2 bg-green-500 cursor-pointer hover:bg-green-600 text-white rounded-full transition-all duration-200">
          {" "}
          <FaPlus />
        </button>
      </div>
      ...
      <div className="overflow-y-auto h-[calc(100vh-120px)]">
        {filteredContacts.map((contact) => (
          <motion.div
            ...
            className={`p-3 flex items-center cursor-pointer ${theme === "dark" ? (selectedContact?._id === contact?._id ? "bg-gray-700" : "hover:bg-gray-800") : selectedContact?._id === contact?._id ? "bg-gray-300" : "hover:bg-gray-200"} border-y  ${theme === 'dark'? 'border-gray-800': 'border-gray-200'}`}
          >
